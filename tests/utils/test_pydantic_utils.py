...
from servequery.legacy.core import get_all_fields_tags
from servequery.pydantic_utils import ALLOWED_TYPE_PREFIXES
...
def test_wrong_classpath():
    class WrongClassPath(ServeQueryBaseModel):
        class Config:
            alias_required = False
