...
from servequery.legacy.test_preset import BinaryClassificationTestPreset
from servequery.legacy.test_preset import BinaryClassificationTopKTestPreset
from servequery.legacy.test_preset import DataDriftTestPreset
from servequery.legacy.test_preset import DataQualityTestPreset
from servequery.legacy.test_preset import DataStabilityTestPreset
from servequery.legacy.test_preset import MulticlassClassificationTestPreset
from servequery.legacy.test_preset import NoTargetPerformanceTestPreset
from servequery.legacy.test_preset import RegressionTestPreset
