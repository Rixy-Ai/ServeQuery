...
from servequery.legacy.ui.dashboards.utils import _get_hover_params
from servequery.legacy.ui.dashboards.utils import getattr_nested
...
def test_metric_hover_template():
    class Nested(ServeQueryBaseModel):
        class Config:
            alias_required = False
