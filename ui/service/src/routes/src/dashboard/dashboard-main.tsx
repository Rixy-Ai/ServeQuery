import { JSONParseExtended } from 'servequery-ui-lib/api/JsonParser'
import { responseParser } from 'servequery-ui-lib/api/client-heplers'
import type { DashboardInfoModel, GetSearchParamsAPIs } from 'servequery-ui-lib/api/types'
import { DashboardWidgets } from 'servequery-ui-lib/components/DashboardWidgets'
import {
  HintOnHoverToPlot,
  type PlotMouseEventType
} from 'servequery-ui-lib/components/OnClickedPoint'
...
} from 'servequery-ui-lib/routes-components/dashboard'
import { Box, Stack } from 'servequery-ui-lib/shared-dependencies/mui-material'
import { useParams } from 'servequery-ui-lib/shared-dependencies/react-router-dom'
